...
function applySparseSelection(targetDir: string): void {
  ...
  const include = (manifest as { include?: unknown }).include;
  ...
  execFileSync(
    'git',
    ['-C', targetDir, 'sparse-checkout', 'set', '--', ...ESSENTIAL_PATHS, ...include],
